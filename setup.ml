...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3539b15ce09cb5ebbcb70ee7655cf8dc) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_litiom_type", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
       ];
     doc = [("litiom", OCamlbuildDocPlugin.doc_build "src")];
     ...
     clean_doc = [("litiom", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test =
       [
          ("test_litiom_type",
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Litiom";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "litiom"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_litiom_type.ml";
                      });
               Test
                 ({
                     cs_name = "test_litiom_type";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\014\191)\228S\148I\163C%\0243\139>\142a";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
