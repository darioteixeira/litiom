...
(* OASIS_START *)
(* DO NOT EDIT (digest: 68022681fbbebd76afc2043e07a946de) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Litiom_type"; "Litiom_choice"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.3";
     oasis_digest = Some "\015/kO\181\229\157{\216\215\181\212\152\159w\132";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
