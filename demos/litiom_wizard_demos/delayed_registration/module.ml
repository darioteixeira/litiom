(********************************************************************************)
(* Simple three step wizard, but one where the registration of the first step	*)
(* is done manually by invoking the normal Eliom mechanisms.			*)
(********************************************************************************)
...
let () = Eliom_predefmod.Xhtml.register ~service:fallback step1_handler
