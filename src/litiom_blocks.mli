(********************************************************************************)
(**	The [Litiom_blocks] module uses the arrow formalism to build a simple
	algebra of [Lwt] functions plumbed together.  It allows for simple
	composition of functions, forking & joining, and placing the result
	of a list of computations inside containers.  The end is to enable
	the construction of page fragments via the composition of simple
	building blocks.
